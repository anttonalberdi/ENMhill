#' Spatial turnover computation based on Hill numbers
#' @title Spatial turnover
#' @author Antton Alberdi, \email{anttonalberdi@gmail.com}
#' @keywords breadth diversity hill
#' @description Compute Hill numbers-based spatial turnover on multiple Environmental Niche Model projection rasters.
...
#' @seealso \code{\link{breadth}}, \code{\link{overlap}}
#' @examples
#' data()
